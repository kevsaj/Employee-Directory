...
export default function Index() {
  ...
  return (
    <>
      ...
      <section className="header relative pt-2 items-center flex h-screen max-h-860-px">
        ...
        <img
          className="absolute top-0 b-auto right-0 pt-16 sm:w-6/12 -mt-48 sm:mt-0 w-10/12 max-h-720px"
